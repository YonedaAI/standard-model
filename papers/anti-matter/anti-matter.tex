...
The experimental confirmation of the positron by Carl Anderson in 1932 (published 1933)~\cite{Anderson1932}
...
\end{equation}
with $\lambda = s_{12} \approx 0.225$, $A \approx 0.826$, $\bar{\rho} \approx 0.159$,
$\bar{\eta} \approx 0.349$~\cite{PDG2024}. The parameter $\eta \neq 0$ is the source
...
\begin{itemize}
    ...
    The experiment produced over 2 million antihydrogen atoms in a single run.
